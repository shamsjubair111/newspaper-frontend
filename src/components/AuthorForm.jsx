            ...
            <div className="card-body p-4">
              ...
              {categories.length === 0 && (
                <div className="alert alert-warning">
                  <strong>⚠️ No categories found!</strong> Please create at
                  least one category first.
                </div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  {authors.length === 0 && (
                    <div className="form-text text-warning">
                      No authors found.{" "}
                      <a href="/create-author">Create an author</a> first.
                    </div>
                  )}
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="form-text">
                    Separate paragraphs with a blank line. Single line breaks
                    become &lt;br&gt;. HTML tags also supported.
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <label htmlFor="videoUrl" className="form-label fw-bold">
                    ...
                    <span className="text-muted">
                      (Optional — YouTube or direct video link)
                    </span>
                  </label>
                  <input
                    type="url"
                ...
                {/* Layout */}
                <div className="mb-4">
                  <label htmlFor="slayout" className="form-label fw-bold">
                    Layout Style
                  </label>
                  <select
                    className="form-select"
